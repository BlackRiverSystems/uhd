 ...
 * Transmit thread
 **********************************************************************/
static void tx_thread(uhd::usrp::multi_usrp::sptr usrp, const double tx_wave_ampl, std::shared_ptr<std::atomic_bool> run)
{
...
int UHD_SAFE_MAIN(int argc, char *argv[])
{
    ...
    auto thread = std::async(std::launch::async, &tx_thread, usrp, tx_wave_ampl, run);
