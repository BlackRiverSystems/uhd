...
e100_impl::e100_impl(const uhd::device_addr_t &device_addr){
    ...
    _tree->create<mboard_eeprom_t>(mb_path / "eeprom")
        .set(mb_eeprom)
        .add_coerced_subscriber(boost::bind(&e100_impl::set_mb_eeprom, this, boost::placeholders::_1));
    ...
    _tree->create<double>(mb_path / "tick_rate")
        ...
        .add_coerced_subscriber(boost::bind(&e100_impl::update_tick_rate, this, boost::placeholders::_1));
    ...
    _tree->create<double>(rx_codec_path / "gains/pga/value")
        .set_coercer(boost::bind(&e100_impl::update_rx_codec_gain, this, boost::placeholders::_1));
    _tree->create<std::string>(tx_codec_path / "name").set("ad9522");
    _tree->create<meta_range_t>(tx_codec_path / "gains/pga/range").set(e100_codec_ctrl::tx_pga_gain_range);
    _tree->create<double>(tx_codec_path / "gains/pga/value")
        .add_coerced_subscriber(boost::bind(&e100_codec_ctrl::set_tx_pga_gain, _codec_ctrl, boost::placeholders::_1))
    ...
    _tree->create<subdev_spec_t>(mb_path / "rx_subdev_spec")
        .add_coerced_subscriber(boost::bind(&e100_impl::update_rx_subdev_spec, this, boost::placeholders::_1));
    _tree->create<subdev_spec_t>(mb_path / "tx_subdev_spec")
        .add_coerced_subscriber(boost::bind(&e100_impl::update_tx_subdev_spec, this, boost::placeholders::_1));
    ...
    for (size_t dspno = 0; dspno < num_rx_dsps; dspno++)
    {
        ...
        _tree->create<double>(rx_dsp_path / "rate/value")
            ...
            .add_coerced_subscriber(boost::bind(&e100_impl::update_rx_samp_rate, this, dspno, boost::placeholders::_1));
    ...
    _tree->create<double>(mb_path / "tx_dsps/0/rate/value")
        ...
        .add_coerced_subscriber(boost::bind(&e100_impl::update_tx_samp_rate, this, 0, boost::placeholders::_1));
    ...
    _tree->create<std::string>(mb_path / "clock_source/value")
        .add_coerced_subscriber(boost::bind(&e100_impl::update_clock_source, this, boost::placeholders::_1));
    ...
    _tree->create<dboard_eeprom_t>(mb_path / "dboards/A/rx_eeprom")
        .set(rx_db_eeprom)
        .add_coerced_subscriber(boost::bind(&e100_impl::set_db_eeprom, this, "rx", boost::placeholders::_1));
    _tree->create<dboard_eeprom_t>(mb_path / "dboards/A/tx_eeprom")
        .set(tx_db_eeprom)
        .add_coerced_subscriber(boost::bind(&e100_impl::set_db_eeprom, this, "tx", boost::placeholders::_1));
    _tree->create<dboard_eeprom_t>(mb_path / "dboards/A/gdb_eeprom")
        .set(gdb_eeprom)
        .add_coerced_subscriber(boost::bind(&e100_impl::set_db_eeprom, this, "gdb", boost::placeholders::_1));
    ...
    BOOST_FOREACH(const std::string &name, _tree->list(db_tx_fe_path)){
        _tree->access<double>(db_tx_fe_path / name / "freq" / "value")
            .add_coerced_subscriber(boost::bind(&e100_impl::set_tx_fe_corrections, this, boost::placeholders::_1));
    }
    const fs_path db_rx_fe_path = mb_path / "dboards" / "A" / "rx_frontends";
    BOOST_FOREACH(const std::string &name, _tree->list(db_rx_fe_path)){
        _tree->access<double>(db_rx_fe_path / name / "freq" / "value")
            .add_coerced_subscriber(boost::bind(&e100_impl::set_rx_fe_corrections, this, boost::placeholders::_1));
    }
    ...
    _tree->access<double>(mb_path / "tick_rate") //now add_coerced_subscriber the clock rate setter
        .add_coerced_subscriber(boost::bind(&e100_clock_ctrl::set_fpga_clock_rate, _clock_ctrl, boost::placeholders::_1));
