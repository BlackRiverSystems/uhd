    ...
    device_addr(_device_addr)
{
    ...
    for (size_t mbi = 0; mbi < device_args.size(); mbi++){
        ...
        _tree->create<mboard_eeprom_t>(mb_path / "eeprom")
            ...
            .add_coerced_subscriber(boost::bind(&usrp2_impl::set_mb_eeprom, this, mb, boost::placeholders::_1));
        ...
        _tree->access<double>(mb_path / "tick_rate")
            .add_coerced_subscriber(boost::bind(&tx_dsp_core_200::set_tick_rate, _mbc[mb].tx_dsp, boost::placeholders::_1));
        ...
        _tree->create<double>(mb_path / "tx_dsps/0/rate/value")
            .set(1e6) //some default
            .set_coercer(boost::bind(&tx_dsp_core_200::set_host_rate, _mbc[mb].tx_dsp, boost::placeholders::_1))
            .add_coerced_subscriber(boost::bind(&usrp2_impl::update_tx_samp_rate, this, mb, 0, boost::placeholders::_1));
        _tree->create<double>(mb_path / "tx_dsps/0/freq/value")
            .set_coercer(boost::bind(&tx_dsp_core_200::set_freq, _mbc[mb].tx_dsp, boost::placeholders::_1));
